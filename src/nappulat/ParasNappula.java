...
public class ParasNappula extends Nappula {
    ...
    public boolean voinkoPyoria(Palanen[][] tutkittavaAlue) {
        ...
        if (asento == 1) {
            if (tutkittavaAlue[0][1] instanceof ReunaPalanen) {
                return false;
            }
            if (tutkittavaAlue[0][1] instanceof TetrisPalanen) {
                return false;
            }
        }
        if (asento == 2) {
            if (tutkittavaAlue[1][2] instanceof ReunaPalanen) {
                return false;
            }
            if (tutkittavaAlue[1][2] instanceof TetrisPalanen) {
                return false;
            }
        }
        if (asento == 3) {
            if (tutkittavaAlue[2][1] instanceof ReunaPalanen) {
                return false;
            }
            if (tutkittavaAlue[2][1] instanceof TetrisPalanen) {
                return false;
            }
        }
        if (asento == 4) {
               if (tutkittavaAlue[1][0] instanceof ReunaPalanen) {
                return false;
            }
            if (tutkittavaAlue[1][0] instanceof TetrisPalanen) {
                return false;
            }
        }
        return true;
    ...
    public void toteutaPyorahdys() {
        ...
        if (asento == 1) {
            ...
            int uusiNeljasSarake = neljas.getSarake() - 1;

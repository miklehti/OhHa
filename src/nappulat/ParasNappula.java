...
public class ParasNappula extends Nappula {
    ...
    public boolean voinkoPyoria(Palanen[][] tutkittavaAlue) {
        ...
        if (asento == 1) {
            if (tutkittavaAlue[0][1] instanceof Palanen) {
                return false;
            }

        }
        if (asento == 2) {
            if (tutkittavaAlue[1][2] instanceof Palanen) {
                return false;
            }

        }
        if (asento == 3) {
            if (tutkittavaAlue[2][1] instanceof Palanen) {
                return false;
            }

        }
        if (asento == 4) {
            if (tutkittavaAlue[1][0] instanceof Palanen) {
                return false;
            }
        }
        return true;
